...
import { GlobalSearch } from '@/features/preptracker/components/reader/GlobalSearch'
import {
  MobileRailButton,
  MobileTreeButton,
} from '@/features/preptracker/components/reader/MobileDrawers'
import { useDailyLog, useStreaks } from '@/features/preptracker/hooks/usePrepTracker'
  ...
  return (
    <header className="flex h-14 items-center gap-2 border-b bg-background/95 px-3 backdrop-blur md:px-6">
      ...
      <Link to={ROUTES.READER} className="flex items-center gap-2 font-semibold">
        <span className="text-primary">PrepTracker</span>
      </Link>
