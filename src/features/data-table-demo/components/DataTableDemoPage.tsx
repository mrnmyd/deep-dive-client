...
import type { DataTableColumnDef, PageRequest, PageResponse } from '@/components/data-table/types'
...
type User = {
  ...
  team: 'Platform' | 'Growth' | 'Support' | 'Other'
  createdAt: string
}
    ...
    <div className="space-y-10 p-6">
      <section className="space-y-4">
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">
            The first table simulates backend pagination, sorting, search, and filtering. The second
            table uses the same component with the full dataset loaded on the client.
          </p>
        </div>
        ...
        <DataTable
          ...
          defaultVisibleColumnIds={['id', 'name', 'email', 'role', 'status', 'createdAt']}
      ...
      <section className="space-y-4">
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">
            No backend pagination props are passed here. Search, sort, filters, and pagination are
            applied against the loaded data in the browser.
          </p>
        </div>
        ...
        <DataTable
          ...
          data={ALL_USERS}
          defaultPageSize={8}
          defaultVisibleColumnIds={['name', 'email', 'status', 'team', 'createdAt']}
        />
      </section>
    </div>
  )
