// DB_NAME keeps its original spelling on rebrand to preserve any
// FileSystemDirectoryHandle a user has already granted. Renaming it would
// orphan that handle and force the user to re-pick their backup folder.
